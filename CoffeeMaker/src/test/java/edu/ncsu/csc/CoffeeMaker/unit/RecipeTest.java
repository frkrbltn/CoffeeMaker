...
public class RecipeTest {
    ...
    public void testDeleteRecipe3 () {
        ...
        service.deleteAll(); // Test deleting from empty db
    ...
    public void testDeleteRecipe4 () {
        ...
        final Recipe r4 = createRecipe( "Chocolate Milk", 60, 0, 3, 2, 5 );
        // service.save( r4 ); // trying to delete a recipe that is not in db

        Assertions.assertEquals( 0, service.count(), "There should be no recipes in the database" );
        service.delete( r4 );
        Assertions.assertEquals( 0, service.count(), "There should be no recipes in the database" );
    ...
    public void testEditRecipe1 () {
        ...
        Assertions.assertEquals( 3, (int) retrieved.searchIngredient( "Coffee" ).getAmount() );
        Assertions.assertEquals( 1, (int) retrieved.searchIngredient( "Milk" ).getAmount() );
        Assertions.assertEquals( 1, (int) retrieved.searchIngredient( "Sugar" ).getAmount() );
        Assertions.assertEquals( 0, (int) retrieved.searchIngredient( "Chocolate" ).getAmount() );
    ...
    public void testUpdateRecipe () {
        ...
        final Recipe r2 = createRecipe( "updated Coffee", 60, 5, 2, 2, 1 );
        ...
        Assertions.assertEquals( 5, (int) retrieved.searchIngredient( "Coffee" ).getAmount() );
        Assertions.assertEquals( 2, (int) retrieved.searchIngredient( "Milk" ).getAmount() );
        Assertions.assertEquals( 2, (int) retrieved.searchIngredient( "Sugar" ).getAmount() );
        Assertions.assertEquals( 1, (int) retrieved.searchIngredient( "Chocolate" ).getAmount() );

        Assertions.assertNull( retrieved.searchIngredient( "Mocha" ) );
