...
public class APICoffeeTest {
    ...
    public void setup () {
        ...
        // ivt.searchIngredient( IngredientType.CHOCOLATE ).setAmount( 15 );
        // ivt.searchIngredient( IngredientType.COFFEE ).setAmount( 15 );
        // ivt.searchIngredient( IngredientType.MILK ).setAmount( 15 );
        // ivt.searchIngredient( IngredientType.SUGAR ).setAmount( 15 );
        ...
        recipe.addIngredient( new Ingredient( "Sugar", 0 ) );

        // recipe.searchIngredient( IngredientType.COFFEE ).setAmount( 3 );
        // recipe.searchIngredient( IngredientType.MILK ).setAmount( 1 );
        // recipe.searchIngredient( IngredientType.SUGAR ).setAmount( 1 );
        // recipe.searchIngredient( IngredientType.CHOCOLATE ).setAmount( 0 );
        service.save( recipe );
    }
    ...
    public void testPurchaseBeverage3 () throws Exception {
        ...
        final Inventory ivt = iService.getInventory();
        ivt.searchIngredient( "Coffee" ).setAmount( 0 );
        iService.save( ivt );
    ...
    public void testPurchaseBeverage4 () throws Exception {
        ...
        mvc.perform( post( String.format( "/api/v1/makecoffee/%s", "Jason" ) ).contentType( MediaType.APPLICATION_JSON )
                .content( TestUtils.asJsonString( -1 ) ) ).andExpect( status().is4xxClientError() )
